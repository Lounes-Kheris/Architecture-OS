...
set title "L1 cache"
plot "ntstore_L1.dat" u 2:xtic(1) t "Intel Core i5-8250U"

set title "L2 cache"
plot "ntstore_L2.dat" u 2:xtic(1) t "Intel Core i5-8250U"

set title "L3 cache"
plot "ntstore_L3.dat" u 2:xtic(1) t "Intel Core i5-8250U"

set title "DRAM"
plot "ntstore_DRAM.dat" u 2:xtic(1) t "Intel Core i5-8250U"
